...
class Test_Window(QMainWindow,Ui_cal_test.Ui_MainWindow):
    def __init__(self):
        ...
        self.symbol_m = ['symbol_1','symbol_2','symbol_3','symbol_4','symbol_5','symbol_6','symbol_7','symbol_8','symbol_9','symbol_10',
            'symbol_11','symbol_12','symbol_13','symbol_14','symbol_15','symbol_16','symbol_17','symbol_18','symbol_19','symbol_20']
        self.num1_m = ['num_1_1','num_1_2','num_1_3','num_1_4','num_1_5','num_1_6','num_1_7','num_1_8','num_1_9','num_1_10',
        'num_1_11','num_1_12','num_1_13','num_1_14','num_1_15','num_1_16','num_1_17','num_1_18','num_1_19','num_1_20',]
        self.num2_m = ['num_2_1','num_2_2','num_2_3','num_2_4','num_2_5','num_2_6','num_2_7','num_2_8','num_2_9','num_2_10',
        'num_2_11','num_2_12','num_2_13','num_2_14','num_2_15','num_2_16','num_2_17','num_2_18','num_2_19','num_2_20',]
        self.answer_m = ['answer_1','answer_2','answer_3','answer_4','answer_5','answer_6','answer_7','answer_8','answer_9','answer_10',
    ...
    def set_symbol(self):
        ...
        for i in self.symbol_m:
            exec("self.%s.setText('%s')"%(i,self.symbol_n[random.randint(0,3)]))
        # for i in self.num1_m:
        #     exec("self.%s.setText('%s')"%(i,str(random.randint(1,999))))
        # for i in self.num2_m:
        #     exec("self.%s.setText('%s')"%(i,str(random.randint(1,999))))
    

    def set_numbers(self):
        for i in range(20):
            # print(eval('self.%s.text()' %self.symbol_m[i]))
            
            if eval('self.%s.text()' %self.symbol_m[i]) == '+':
               exec("self.%s.setText('%s')"%(self.num1_m[i],str(random.randint(1,99))))
               exec("self.%s.setText('%s')"%(self.num2_m[i],str(random.randint(1,99))))
